...
<head>
    ...
    <!-- Slick carousel -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/library/slick/slick.css') }}">
...
<body>
    ...
    <div class="search-wrapper">
        ...
        <form role="search" method="get" class="search-form" action="#">
            <input type="search" name="s" id="s" placeholder="Search Keyword" class="searchbox-input"
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-7 col-lg-6 res-margin">
                    ...
                    <div class="banner-text">
                        ...
                        <h1 class="wow fadeInUp" data-wow-offset="10" data-wow-duration="1s" data-wow-delay="0s">
                            Get the new App for <br class="d-none d-xl-block"> Android
                        </h1>
                        ...
                        <div class="button-store wow fadeInUp" data-wow-offset="10" data-wow-duration="1s"
                            ...
                            <a href="{{ route('downloadfile') }}"
                                class="custom-btn auto-width d-inline-flex align-items-center m-2 m-sm-0 me-sm-3">
                                <i class="fab fa-google-play"></i>
                                <p><span>Download</span></p>
                            </a>

                            <a href="https://forms.gle/N9SyYdy1fdki3cZd7"
                                class="custom-btn auto-width d-inline-flex align-items-center m-2 m-sm-0">
                                <p><span>Isi Kuisioner</span></p>
                            </a>
                ...
                <div class="col-12 col-md-5 col-lg-6">
                    ...
                    <div class="banner-image-center wow fadeInUp" data-wow-offset="10" data-wow-duration="1s"
                        data-wow-delay="0.3s">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 res-margin wow fadeInUp" data-wow-offset="10" data-wow-duration="1s"
                    data-wow-delay="0">
                    <div class="service-single service-style-2">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-6">
                    ...
                    <div class="section-title text-center">
                        ...
                        <p>Sed laoreet diam sagittis tempus convallis. Interdum et malesuada fames ac ante ipsum primis
                            in faucibus. </p>
                    </div>
                        ...
                        <li>
                            <div class="feature-box d-flex">
                                ...
                                <div class="box-text align-self-center align-self-md-start">
                                    ...
                                    <p>Semper a augue suscipit, luctus neque purus ipsum neque dolor primis libero
                                        tempus velna culpa expedita.</p>
                                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-6">
                    ...
                    <div class="section-title text-center">
                        ...
                        <p>Cras fringilla, lectus sed ullamcorper fringilla. Massa ex accumsan odio, quis iaculis justo
                            magna quis tortor.</p>
                    </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p class="text-center mb-0">Still have a question? <a href="#contact"><strong>Ask your question
                                here</strong></a></p>
                </div>
            </div>
