                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-5">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" required name="alamat" id="exampleFormControlTextarea1" rows="2">{{ $penginapan->alamat }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label">Fasilitas</label>
                                    <textarea class="form-control" required name="fitur" id="exampleFormControlTextarea1" rows="2">{{ $penginapan->fitur }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="latitude" required id="latitude"
                                        value="{{ $penginapan->latitude }}" placeholder="latitude">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="longitude" required id="longitude"
                                        value="{{ $penginapan->longitude }}" placeholder="longitude">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="operating_hours" required
                                        value="{{ $penginapan->operating_hours }}" placeholder="04:00 AM - 04:00 PM">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Telp. Pengelola
                                        penginapan</label>
                                    <input type="text" class="form-control" name="telp" id="telp"
                                        value="{{ $penginapan->telp }}" placeholder="Telp. Pengelola">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label">Deskripsi penginapan</label>
                                    <textarea class="form-control" required name="deskripsi" id="exampleFormControlTextarea1" rows="2">{{ $penginapan->deskripsi }}</textarea>
                                </div>
